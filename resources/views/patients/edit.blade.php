        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="d-flex align-items-center mb-4">
                    <a href="{{ route('patients.show', $patient->id) }}" class="btn btn-light rounded-circle me-3"
                        style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                        <i class="bi bi-arrow-left"></i>
                    </a>
                    <div>
                        <h1 class="fw-bold mb-0" style="color: #4f4f4f;">Editar Paciente</h1>
                        <p class="text-secondary mb-0">Atualizar informações cadastrais</p>
                    </div>
                </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="phone"
                                        ...
                                        placeholder="Ex: (44) 99999-9999" value="{{ old('phone', $patient->phone) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        placeholder="contato@exemplo.com" value="{{ old('email', $patient->email) }}"
                                        style="border-radius: 10px; background-color: #F8F9FA; border-color: #eee;">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="discovery_source"
                                        ...
                                        style="border-radius: 10px; background-color: #F8F9FA; border-color: #eee;">
                                        <option value="">Selecione...</option>
                                        <option value="Instagram" {{ old('discovery_source', $patient->discovery_source) == 'Instagram' ? 'selected' : '' }}>Instagram</option>
                                        <option value="Facebook" {{ old('discovery_source', $patient->discovery_source) == 'Facebook' ? 'selected' : '' }}>Facebook</option>
                                        <option value="Google" {{ old('discovery_source', $patient->discovery_source) == 'Google' ? 'selected' : '' }}>Google</option>
                                        <option value="Indicação" {{ old('discovery_source', $patient->discovery_source) == 'Indicação' ? 'selected' : '' }}>Indicação</option>
                                        <option value="Outros" {{ old('discovery_source', $patient->discovery_source) == 'Outros' ? 'selected' : '' }}>Outros</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="registration_date"
                                        ...
                                        value="{{ old('registration_date', $patient->registration_date ? \Carbon\Carbon::parse($patient->registration_date)->format('Y-m-d') : '') }}"
                                        style="border-radius: 10px; background-color: #F8F9FA; border-color: #eee;">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="clinical_observations" rows="4"
                                        ...
                                        style="border-radius: 12px; background-color: #F8F9FA; border-color: #eee;">{{ old('clinical_observations', $patient->clinical_observations) }}</textarea>
