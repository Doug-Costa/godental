...
<body>
    @if($hash == null)
        <div data-vimeo-id="{{ $id }}" data-vimeo-watch-later="false" data-vimeo-responsive="true"
            data-vimeo-autoplay="true" id="handstick"></div>
    @else
        <div data-vimeo-url="https://player.vimeo.com/video/{{ $id }}?h={{ $hash }}" data-vimeo-watch-later="false"
            data-vimeo-responsive="true" data-vimeo-autoplay="true" id="playertwo"></div>
    @endif
</body>
