...
@section('content')
  ...
  <section class="hero-wrap">
    <div class="container">
      <div class="d-flex justify-content-end align-items-center mb-3 mt-4 gap-3 flex-wrap">
        <button type="button" class="btn btn-lg px-4 text-white shadow-sm d-flex align-items-center gap-2"
          style="background: linear-gradient(135deg, #CA1D53, #7c1233); border: none; border-radius: 12px; font-weight: 600;"
          data-bs-toggle="modal" data-bs-target="#modalGoIntelligence">
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item active position-relative">
                <a href="https://dentalgo.com.br/facelift25/revista/1138/Clinical-2025-v24n05/5">
                  ...
                  <img class="d-block d-lg-none" src="{{ asset('facelift2/img/clinical32.png') }}" alt="Banner Mobile 1">
                </a>
              </div>
              ...
              <div class="carousel-item position-relative">
                <a href="https://dentalgo.com.br/facelift25/revista/1140/Est%C3%A9tica-%7C-JCDR-2025-v22n3/4">
                  ...
                  <img class="d-block d-lg-none" src="{{ asset('facelift2/img/estetica32.png') }}" alt="Banner Mobile 3">
                </a>
              </div>
              ...
              <div class="carousel-item position-relative">
                <a href="https://dentalgo.com.br/facelift25/revista/1137/Periodontology-2025-v35n3/50">
                  ...
                  <img class="d-block d-lg-none" src="{{ asset('facelift2/img/perio32.png') }}" alt="Banner Mobile 3">
                </a>
              </div>
              ...
              <div class="carousel-item position-relative">
                <a href="https://dentalgo.com.br/facelift25/revista/1141/Orofacial-Harmony-2025-v3n2/67">
                  ...
                  <img class="d-block d-lg-none" src="{{ asset('facelift2/img/hof32.png') }}" alt="Banner Mobile 3">
                </a>
              </div>
              ...
              <div class="carousel-item position-relative">
                <a href="https://dentalgo.com.br/facelift25/revista/1142/Journal-2025-v30n6/6">
                  ...
                  <img class="d-block d-lg-none" src="{{ asset('facelift2/img/dpjo32.png') }}" alt="Banner Mobile 3">
                </a>
              </div>
              ...
              <div class="carousel-item position-relative">
                <a href="https://dentalgo.com.br/facelift25/revista/1139/JBCOMS-2025-V11N4/1">
                  ...
                  <img class="d-block d-lg-none" src="{{ asset('facelift2/img/jbcoms32.png') }}" alt="Banner Mobile 3">
                </a>
              </div>
        ...
        <a href="{{ route('facevideo')}}/{{ $video->collection_id }}/{{ str_replace(' ', '-', $video->title) }}/{{ $video->id }}"
          ...
          <div class="slider-card-top">
            <div class="d-flex justify-content-center align-items-center mb-4">
              <img src="{{ $video->cover }}" alt="{{ $video->title }}" class="top-slider-img" style="border-radius: 15px">
            </div>
          </div>
        </a>
      @endforeach
  ...
  @include('facelift2.partials.goclinic_logic')
